...
```{r ch11-homework-q3}
# load data
# the problem statement states to list both aeronet & AMOD as independent variables, and doesn't state a dependent variable. For the sake of completing this HW, I will treat AMOD as the dependent variable. 

calaod <- read_csv("cal_aod.csv")
modelq3 <- lm(aeronet ~ amod, data = calaod)
...
# mean must be zero because the sum of the sum of the residuals squared is zero for the lm() function 
